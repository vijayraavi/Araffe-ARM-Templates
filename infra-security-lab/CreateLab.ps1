...
$outputs = (new-azurermresourcegroupdeployment -Name infraSecLab -ResourceGroupName $rg -TemplateUri https://raw.githubusercontent.com/azurecitadel/ARM-Templates/master/infra-security-lab/azuredeploy.json).Outputs
...
new-azurermresourcegroupdeployment -Name infraSecpaasLab -ResourceGroupName $rg2 -TemplateUri https://raw.githubusercontent.com/azurecitadel/ARM-Templates/master/infra-security-lab/azuredeploy-paas.json
